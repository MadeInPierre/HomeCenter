...
class TestScreen():
    ...
    def Draw(self, gameDisplay):
        ...
        self.AujourdhuiText = self.TitleFont.render(str(self.chrono.elapsed_time()), True, (self.Aujourdhui_color, self.Aujourdhui_color, self.Aujourdhui_color))
        ...
        for i in range (0, 7):
            ...
            self.temperature = TitleFont.render(WeatherManager.temperatures[i], True, (255, 255, 255))
